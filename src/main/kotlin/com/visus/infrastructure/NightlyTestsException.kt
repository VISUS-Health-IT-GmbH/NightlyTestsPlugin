 ...
 *  @author thahnen
 */
internal sealed class NightlyTestsException(message: String) : InvalidUserDataException(message)


/** Exception thrown when no configuration provided in projects gradle.properties file */
internal class MissingPropertiesEntryException(message: String) : NightlyTestsException(message)


/** Exception thrown when value of necessary property entry is invalid (no content) */
internal class PropertiesEntryInvalidException(message: String) : NightlyTestsException(message)
 ...
 */
internal  class TaskWithTypeTestNotFoundException(message: String) : NightlyTestsException(message)
